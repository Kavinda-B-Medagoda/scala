object Q4_ListAccounts extends App {
  ...
  val account1= new BankAccount1("Kevin",22275,10500.00)
  val account2= new BankAccount1("Terry",32478,5700.00)
  val account3= new BankAccount1("Ben",12030,1890.00)
  val account4= new BankAccount1("Daniel",12040,-3000.00)
